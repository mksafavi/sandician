...
mod powder {
    ...
    #[test]
    fn test_weighted_particle_fall_with_maximum_vertical_velocity_probability() {
        /*
         * S -> -
         * -    S
         */
    ...
    #[test]
    fn test_weighted_particle_should_use_the_same_vertical_velocity_probability_for_all_direction_checks_so_that_it_spreads_less()
     {
        /*
         * -S- -> -S-
         * ---    ---
